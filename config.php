...
switch ($today) {
    case 'Monday' :
        ...
        $pic = 'monday2.jpg';
        $alt = 'Morning Baja Adventure Yoga Class';
        $content = 'Monday\'s yoga adventure class will be held on the beach in beautiful Baja Mexico at sunrise. This class is perfect to immerse yourself into a quiet, calm and serene morning practice. Please come prepared to start your week off to the brilliant red and orange sunrise';
