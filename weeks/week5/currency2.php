...
<head>
    <meta charset="UTF-8">
    <title>Our Currency 2 Form with a dropdown - select option</title>
...
<fieldset>
    <legend>Welcome to our currency exchange calculator</legend>
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    // if our post's name, email, currency, and amount is empty, we
    //will all out a specific echo
    ...
    if(isset(
        ...
        <div class="box">
        <h2>Hello, '.$name.'</h2>
        <p>You name have $'.$friendly_total.' American Dollars, and it will be deposited in <b>'.$bank.'</b> and we will email you at <b>'.$email.'</b> in the next 24 hours!</p>
        </div>
        ';
    } // close isset
