...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // the logic is if post wines IS NOT empty,
    // then we need to grab the wines and display them
    // just lie we did in our impolde.php
    function my_wines( ) {
        $my_return = '';
        if(!empty($_POST['wines'])) {
...
<?php if(isset($_POST['gender']) && $_POST['gender'] == 'female') echo 'checked="checked"';?>
        ...
        <ul>
            <li>
                <input type="checkbox" name="wines[]" value="cab"<?php if(isset($_POST['wines']) && in_array('cab', $wines)) echo 'checked="checked"'; ?>
                >Cabernet
            </li>
            <li>
        ...
        <select name="regions">
            ...
            >Southeast</option>
            <option value="so"<?php if(isset($_POST['regions']) && $_POST['regions'] == 'so') echo 'selected="selected"';?>
            >South</option>
        </select>
        <span class="error">
